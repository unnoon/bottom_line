 ...
 */
export const array: (obj) => obj is any[] = Array.isArray;
 ...
 */
export function nan(value): boolean
{
 ...
 */
export function number(value): value is number
{
 ...
 */
export function string(value): value is string
{
